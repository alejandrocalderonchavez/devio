...
export default function ProjectOnboardingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newProject: ProjectItem = {
      ...
      legalName: projectGeneralData.legalName || projectGeneralData.name || "Nuevo Desarrollo",
      description: projectGeneralData.description || "",
      googleMapsUrl: projectGeneralData.googleMapsUrl || "",
      websiteUrl: projectGeneralData.websiteUrl || "",
      ...
      logo: projectLogoPreview || undefined,
      logoUrl: projectLogoPreview || undefined,
      logoFileName: projectLogoName || undefined,
      progressPct: 0,
      ...
      try {
        const res = await fetch("/api/projects", {
          ...
          body: JSON.stringify({
            ...
            legalName: newProject.legalName,
            type: newProject.type,
            currency: newProject.currency || "MXN",
