      ...
      >
          ...
          {screen === "main" ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.75rem" }}>
                ...
                {/* Header Actions — only notification bell & avatar */}
        ...
        <div
          style={{
            ...
            alignItems: "center",
            padding: "0 12px",
            boxShadow: "0 8px 32px rgba(15, 23, 42, 0.25), 0 2px 8px rgba(0, 0, 0, 0.10)",
            zIndex: 30,
          }}
        >
          <button
          ...
          >
            <div style={{
              ...
              height: "28px",
              borderRadius: "14px",
              backgroundColor: activeTab === "properties" ? "rgba(255, 255, 255, 0.16)" : "transparent",
              border: activeTab === "properties" ? "1px solid rgba(255, 255, 255, 0.25)" : "1px solid transparent",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}>
          ...
          >
            <div style={{
              ...
              height: "28px",
              borderRadius: "14px",
              backgroundColor: activeTab === "profile" ? "rgba(255, 255, 255, 0.16)" : "transparent",
              border: activeTab === "profile" ? "1px solid rgba(255, 255, 255, 0.25)" : "1px solid transparent",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}>
